...
const Color darkPurpleColor = Color(0xFF3e0950);
const Color lightPurpleColor = Color(0xFF6e0c39);
const Color purpleBorderColor = Color(0xFF62284d);
const Color boxBgColor = Color(0xFF100b25);
const Color yellowTextColor = Color(0xFF80620e);
const Color yellowBgColor = Color(0xFFf8d23d);
const Color yellowBg1Color = Color(0xffdbb51f);
const Color gradientyellow1Color = Color(0xfff7b721);
const Color gradientyellow2Color = Color(0xffffa711);
const Color grayBgColor = Color(0xFF423b41);
